...
PICS = (environ.get('PICS', 'https://files.catbox.moe/qi9n51.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003029622103 -1002997204314').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003146779510')).split()]  # For Multiple Id Use One Space Between Each.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "fellow-delinda-eternals7-3c26ccef.koyeb.app/")
