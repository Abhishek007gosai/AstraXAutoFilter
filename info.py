...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003029622103 -1003242480631 -1002997204314').split()]  # For Multiple Id Use One Space Between Each.
