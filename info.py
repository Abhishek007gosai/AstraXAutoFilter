...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002380726940'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001457313028') # give your force subscribe channel id here else leave it blank
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Anime_Kaizuki')
